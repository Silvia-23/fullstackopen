...
const App = () => {
  ...
  return (
    <div>
      ...
      <StatisticEntry text={allText} count={bad + good + neutral} />
      <StatisticEntry text={averageText} count={(good - bad) / (good + neutral + bad)} />
      <StatisticEntry text={positiveText} count={good / (good + bad + neutral)} />
</div>
  )
}
